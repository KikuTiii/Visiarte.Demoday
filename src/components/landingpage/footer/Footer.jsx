    ...
    return (
        <>
            ...
            <div className={styles.top}>
                ...
                <Link to="/" className={styles.logo}><svg
                            viewBox="0 0 43 33"
                            fill="none"
                ...
                <div className={styles.items}>
                        <Link to="/freelancer" className={styles.item}>Freelancer</Link>
                        <a href="https://linktr.ee/VisiArte"className={styles.item}>Contato</a>
                        <Link to="/sobrenos" className={styles.item}>Sobre Nós</Link>
                </div>
                    <div className={styles.redes}>
                <a target="_blank"href="https://www.instagram.com/visiarte_oficial/"className={styles.redesocial}><img src={insta} alt="Logo Instagram"></img></a>
            </div>
            </div>

            <div className={styles.bottom}>
                <p className={styles.contato}>E-mail: visiarte3@gmail.com</p>
